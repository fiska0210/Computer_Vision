...
def main():
    ...
    im0 = np.array(cv2.imread('./testdata/tsukuba/im3.png', cv2.IMREAD_GRAYSCALE))
    im1 = np.array(cv2.imread('./testdata/tsukuba/im4.png', cv2.IMREAD_GRAYSCALE))
    ...
    cv2.imwrite('tsukuba_new.png', np.uint8(disparity * 16))
    # plt.show()
